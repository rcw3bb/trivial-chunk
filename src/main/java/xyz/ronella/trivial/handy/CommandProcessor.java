...
/**
 * A utility class for running executable commands.<br/>
 *
 * This class provides various methods to process commands using different configurations
 * of process builders, initialization logic, and output handling logic.
 *
 * @author Ron Webb
 * @since 2.18.0
 */
final public class CommandProcessor {
     ...
     * @throws CommandProcessorException if an I/O error occurs.
     */
